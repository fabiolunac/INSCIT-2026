...
REM
REM Generated by Vivado on Mon Apr 13 21:32:03 +0200 2026
...
echo "xvlog --incr --relax -prj shaper_tb_vlog.prj"
call xvlog  --incr --relax -prj shaper_tb_vlog.prj -log xvlog.log
